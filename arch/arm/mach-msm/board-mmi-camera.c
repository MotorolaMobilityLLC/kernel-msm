...
static struct msm_camera_csi_lane_params ov7736_csi_lane_params = {
	.csi_lane_assign = 0xE4,
	.csi_lane_mask = 0x1,
};
...
static struct msm_camera_sensor_platform_info sensor_board_info_ov7736 = {
	.mount_angle = 270,
	.csi_lane_params = &ov7736_csi_lane_params,
};

struct msm_camera_sensor_info msm_camera_sensor_ov7736_data = {
	.sensor_name          = "ov7736",
	.pdata                = &msm_camera_csi_device_data[1],
...
static struct msm_camera_sensor_platform_info sensor_board_info_ov10820 = {
	.mount_angle = 90,
	.csi_lane_params = &ov10820_csi_lane_params,
};

struct msm_camera_sensor_info msm_camera_sensor_ov10820_data = {
	.sensor_name = "ov10820",
	.pdata = &msm_camera_csi_device_data[0],
	.flash_data = &camera_flash_none,
	.sensor_platform_info = &sensor_board_info_ov10820,
	.csi_if = 1,
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = BAYER_SENSOR,
