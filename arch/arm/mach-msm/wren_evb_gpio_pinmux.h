#ifndef _WREN_EVB_GPIO_PINMUX_H_
#define _WREN_EVB_GPIO_PINMUX_H_

#include "sparrow_gpio_pinmux_setting.h"

static struct msm_gpiomux_config wren_evb_msm8226_gpio_configs[] __initdata= {
...
#endif  /* _WREN_EVB_GPIO_PINMUX_H_  */
