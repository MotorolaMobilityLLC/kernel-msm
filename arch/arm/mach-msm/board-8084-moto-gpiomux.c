 ...
 * Copyright 2014 Motorola Mobility LLC
 *
...
static struct msm_gpiomux_config msm_blsp_configs[] __initdata = {
	...
	{
		.gpio      = 55,		/* BLSP2 UART3 TX */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_uart_config,
		},
	},
	{
		.gpio      = 56,		/* BLSP2 UART3 RX */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_uart_config,
		},
	},
	{
		.gpio      = 57,		/* BLSP2 UART3 CTS */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_uart_config,
		},
	},
	{
		.gpio      = 58,		/* BLSP2 UART3 RFR */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_uart_config,
		},
	},
...
static struct gpiomux_setting quat_act_cfg = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting quat_sus_cfg = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};

static struct msm_gpiomux_config apq8084_quat_auxpcm_configs[] __initdata = {
	{
		.gpio = 92,
		.settings = {
			[GPIOMUX_SUSPENDED] = &quat_sus_cfg,
			[GPIOMUX_ACTIVE] = &quat_act_cfg,
		},
	},
	{
		.gpio = 93,
...
static struct msm_gpiomux_config bcm2079x_configs[] __initdata = {
	{
		/* MPP 5 is configured for NFC_WAKE */
		.gpio = 116, /* REG_PU*/
		.settings = {
...
void __init apq8084_moto_init_gpiomux(void)
{
	...
	msm_gpiomux_install(apq8084_quat_auxpcm_configs,
		ARRAY_SIZE(apq8084_quat_auxpcm_configs));
