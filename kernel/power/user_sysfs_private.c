...
#ifndef CONFIG_PINCTRL_MSM_MODULE
...
EXPORT_SYMBOL_GPL(tlmm_before_sleep_save_configs);
...
EXPORT_SYMBOL_GPL(tlmm_before_sleep_set_configs);
			...
			char *buf)
{
	...
	pm_get_active_wakeup_sources(s, PAGE_SIZE - (s - buf));
	s += strlen(s);
