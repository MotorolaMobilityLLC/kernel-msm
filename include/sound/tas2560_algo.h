...
#define TAS2560_ALGO_GET_IDX(X1, X2)		((X1 - 1) * 30 + (X2 - 8) / 4)
/*Special parameter ranges from 3810 to 3899
 (these are handled in capiv2 framework and doesnt reach core algorithm)*/
#define TAS2560_ALGO_IS_SPL_IDX(X)		((((X) >= 3810) && ((X) < 3899)) ? 1 : 0)
/*Param Id to be sent to capiv2 library
* |31 . . . . 24|23 . . . . . 24|15 . . . . . . . . . . 0|
* |Instance ID	|Length		|Parameter Index	 |
*/
#define TAS2560_ALGO_CALC_PIDX(X1, X2, X3, X4)	(X1 | X2 | (X3 << 16) | (((X4 - SLAVE_BASE) / 2) << 24))
#define TAS2560_ALGO_MIN(X1, X2)		((X1 < X2) ? (X1) : (X2))
...
#define TAS2560_ALGO_CFG_SET_RE			3816	/*Set Calibrated Rdc*/
#define TAS2560_ALGO_CALIB_START_F0_Q		3817	/*Start Command for F0,Q test*/
#define TAS2560_ALGO_CALIB_STOP_F0_Q		3818	/*Stop Command for F0,Q test*/
#define TAS2560_ALGO_PROFILE			3819	/*Set Profile(Music(0),Ringtone(1)...etc)*/
