...
#define PSY_IIO_INPUT_VOLTAGE_LIMIT 0x106
#define PSY_IIO_MANUFACTURER 0x107
#define PSY_IIO_MODEL_NAME 0x108
...
#define PSY_IIO_QC3P_FIRMWARE_NUM 0x112
...
#define PSY_IIO_MMI_CP_CHIP_ID 0x119
