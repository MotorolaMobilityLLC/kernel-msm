...
static int msm_pwm_vibrator_get_next(struct timed_vibrator_data *vib)
{
	int next;
...
static int msm_pwm_vibrator_remove(struct platform_device *pdev)
{
...
static int msm_pwm_vibrator_suspend(struct platform_device *pdev,
		pm_message_t state)
{
	struct timed_vibrator_data *vib = platform_get_drvdata(pdev);
...
static int msm_pwm_vibrator_resume(struct platform_device *pdev)
{
	struct timed_vibrator_data *vib = platform_get_drvdata(pdev);
...
static void msm_pwm_vibrator_shutdown(struct platform_device *pdev)
{
	struct timed_vibrator_data *vib;
...
static struct platform_driver msm_pwm_vibrator_driver = {
	.probe = msm_pwm_vibrator_probe,
	.remove = msm_pwm_vibrator_remove,
	.shutdown = msm_pwm_vibrator_shutdown,
	.suspend = msm_pwm_vibrator_suspend,
	.resume = msm_pwm_vibrator_resume,
	.driver = {
		.name = DEVICE_NAME,
