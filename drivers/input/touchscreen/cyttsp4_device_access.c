...
/* <DTS2013081204137 vaibhav 20130812 begin */
...
/* DTS2013081204137 vaibhav 20130812 end> */
...
static int cyttsp4_grpdata_show_registers(struct device *dev, u8 *ic_buf,
		u32 length, int num_read, int offset, int mode)
{
	struct cyttsp4_device_access_data *dad = dev_get_drvdata(dev);
	int rc;
 ...
 * Prints contents of the touch parameters a row at a time.
 */
 /* < DTS2013083008021  songrongyuan 20130830 begin */
...
/* DTS2013083008021 songrongyuan 20130830 end > */
/*
 * SysFs grpdata show function implementation of group 6.
 * Prints contents of the touch parameters a row at a time.
 */
...
static int cyttsp4_check_raw_data(struct device *dev)
{
    ...
    /* < DTS2013081606293 shenjinming 20130816 begin */
    ...
    /* DTS2013081606293 shenjinming 20130816 end > */
...
/* <DTS2013110702788 vaibhav 20131107 begin */
...
cyttsp4_check_open_data_err_release:
 ...
 exit:
	...
	/* < DTS2014012205275 shenjinming 20140122 begin */
	/* update the buf according to rc result */
	cyttsp4_out_to_buf(rc, buf);
	/* DTS2014012205275 shenjinming 20140122 end > */

	return rc;
}
/* DTS2013110702788 vaibhav 20131107 end> */
/* DTS2014021202262 zhangmin 20140212 end > */
EXPORT_SYMBOL(cyttsp4_get_panel_data_check);
/* <DTS2013110507663 vaibhav 20131105 begin */
...
/* DTS2013110507663 vaibhav 20131105 end> */
