			     ...
			     int fw_size)
{
	...
	u32 row_buf_size = 1024 > CY_MAX_PRBUF_SIZE ?
		...
		const u8 *fw_img, int fw_size)
{
	...
	/* DTS2013032808590 shenjinming 20130328 end > */
...
/* < DTS2013121402231 shenjinming 20131215 begin */
...
/* DTS2013121402231 shenjinming 20131215 end > */
		...
		const struct firmware *fw)
{
	...
	upgrade = cyttsp4_check_firmware_version(ttsp, fw_ver_new,
			fw_revctrl_new_h, fw_revctrl_new_l);
	/* <DTS2014032902061  weiqiangqiang 20140401 begin */
	...
	return 0;
	/* DTS2014032902061  weiqiangqiang 20140401 end> */
}
		...
		const u8 *ttconfig_data, int ttconfig_size)
{
	struct device *dev = &ttsp->dev;
	int rc, rc2;
	/* < DTS2013032808590 shenjinming 20130328 begin */
	struct cyttsp4_loader_data *data = dev_get_drvdata(dev);
	/* DTS2013032808590 shenjinming 20130328 end > */
