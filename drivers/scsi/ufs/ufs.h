...
#if defined(CONFIG_UFSHPB) || defined(CONFIG_UFSHPB_31)
...
enum device_desc_param {
	...
	DEVICE_DESC_PARAM_RING_BUF_VER		= 0x5B,
#endif
...
#endif
#if defined(CONFIG_UFSRINGBUF)
	GEOMETRY_DESC_RINGBUF_MAX_HIST_BUFSIZE	= 0x57,
#endif
};
...
#if defined(CONFIG_UFSTW) || defined(CONFIG_UFSTW_31)
	MASK_EE_TW		= (1 << 5),
#endif
};
