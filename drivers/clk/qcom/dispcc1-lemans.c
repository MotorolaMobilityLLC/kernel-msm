...
static struct clk_vdd_class *disp_cc_1_lemans_regulators[] = {
	&vdd_mm,
};
...
static struct alpha_pll_config mdss_1_disp_cc_pll0_config = {
	.l = 0x3A,
	.cal_l = 0x44,
	.alpha = 0x9800,
...
static struct alpha_pll_config mdss_1_disp_cc_pll1_config = {
	.l = 0x1F,
	.cal_l = 0x44,
	.alpha = 0x4000,
	.config_ctl_val = 0x20485699,
...
static struct clk_regmap *disp_cc_1_lemans_clocks[] = {
	...
	[DISP_CC_MDSS_DPTX0_CRYPTO_CLK_SRC] = &mdss_1_disp_cc_mdss_dptx0_crypto_clk_src.clkr,
	...
	[DISP_CC_MDSS_DPTX0_PIXEL2_CLK] = &mdss_1_disp_cc_mdss_dptx0_pixel2_clk.clkr,
	[DISP_CC_MDSS_DPTX0_PIXEL2_CLK_SRC] = &mdss_1_disp_cc_mdss_dptx0_pixel2_clk_src.clkr,
	[DISP_CC_MDSS_DPTX0_PIXEL3_CLK] = &mdss_1_disp_cc_mdss_dptx0_pixel3_clk.clkr,
	[DISP_CC_MDSS_DPTX0_PIXEL3_CLK_SRC] = &mdss_1_disp_cc_mdss_dptx0_pixel3_clk_src.clkr,
	...
	[DISP_CC_MDSS_DPTX1_CRYPTO_CLK_SRC] = &mdss_1_disp_cc_mdss_dptx1_crypto_clk_src.clkr,
...
static const struct qcom_reset_map disp_cc_1_lemans_resets[] = {
	[DISP_CC_MDSS_CORE_BCR] = { 0x8000 },
	[DISP_CC_MDSS_RSCC_BCR] = { 0xa000 },
};

static const struct regmap_config disp_cc_1_lemans_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static struct qcom_cc_desc disp_cc_1_lemans_desc = {
	.config = &disp_cc_1_lemans_regmap_config,
	.clks = disp_cc_1_lemans_clocks,
	.num_clks = ARRAY_SIZE(disp_cc_1_lemans_clocks),
	.resets = disp_cc_1_lemans_resets,
	.num_resets = ARRAY_SIZE(disp_cc_1_lemans_resets),
	.clk_regulators = disp_cc_1_lemans_regulators,
	.num_clk_regulators = ARRAY_SIZE(disp_cc_1_lemans_regulators),
	.critical_clk_en = critical_clk_list,
	.num_critical_clk = ARRAY_SIZE(critical_clk_list),
};

static const struct of_device_id disp_cc_1_lemans_match_table[] = {
	{ .compatible = "qcom,lemans-dispcc1" },
	{ }
};
MODULE_DEVICE_TABLE(of, disp_cc_1_lemans_match_table);
...
static int disp_cc_1_lemans_probe(struct platform_device *pdev)
{
	...
	ret = register_qcom_clks_pm(pdev, true, &disp_cc_1_lemans_desc);
	if (ret)
		dev_err(&pdev->dev, "Failed register disp_cc_1_pm_rt_ops clocks\n");

	clk_lucid_evo_pll_configure(&mdss_1_disp_cc_pll0, regmap, mdss_1_disp_cc_pll0.config);
	clk_lucid_evo_pll_configure(&mdss_1_disp_cc_pll1, regmap, mdss_1_disp_cc_pll1.config);
...
static void disp_cc_1_lemans_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &disp_cc_1_lemans_desc);
}

static struct platform_driver disp_cc_1_lemans_driver = {
	.probe = disp_cc_1_lemans_probe,
	.driver = {
		.name = "disp_cc_1-lemans",
		.of_match_table = disp_cc_1_lemans_match_table,
		.sync_state = disp_cc_1_lemans_sync_state,
	},
};

static int __init disp_cc_1_lemans_init(void)
{
	return platform_driver_register(&disp_cc_1_lemans_driver);
}
subsys_initcall(disp_cc_1_lemans_init);

static void __exit disp_cc_1_lemans_exit(void)
{
	platform_driver_unregister(&disp_cc_1_lemans_driver);
}
module_exit(disp_cc_1_lemans_exit);

MODULE_DESCRIPTION("QTI DISP_CC_1 LEMANS Driver");
