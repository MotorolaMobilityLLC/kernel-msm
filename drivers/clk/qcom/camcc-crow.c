...
static struct clk_vdd_class *cam_cc_crow_regulators[] = {
	&vdd_cx,
	&vdd_mxa,
	&vdd_mxc,
};

static struct clk_vdd_class *cam_cc_crow_regulators_1[] = {
	&vdd_cx,
	&vdd_mxc,
};

static struct clk_vdd_class *cam_cc_crow_regulators_2[] = {
	&vdd_cx,
	&vdd_mxa,
};
...
static const struct parent_map cam_cc_parent_map_10[] = {
	{ P_BI_TCXO, 0 },
	{ P_CAM_CC_PLL0_OUT_MAIN, 1 },
	{ P_CAM_CC_PLL7_OUT_EVEN, 2 },
	{ P_CAM_CC_PLL7_OUT_MAIN, 3 },
	{ P_CAM_CC_PLL0_OUT_ODD, 5 },
	{ P_CAM_CC_PLL0_OUT_EVEN, 6 },
};
...
static struct clk_rcg2 cam_cc_bps_clk_src = {
	...
	.clkr.vdd_data = {
		.vdd_classes = cam_cc_crow_regulators_1,
		.num_vdd_classes = ARRAY_SIZE(cam_cc_crow_regulators_1),
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
			[VDD_LOWER] = 300000000,
			[VDD_LOW] = 410000000,
...
static struct clk_rcg2 cam_cc_cphy_rx_clk_src = {
	...
	.clkr.vdd_data = {
		.vdd_classes = cam_cc_crow_regulators_2,
		.num_vdd_classes = ARRAY_SIZE(cam_cc_crow_regulators_2),
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
			[VDD_LOWER] = 300000000,
			[VDD_LOW] = 400000000},
...
static const struct freq_tbl ftbl_cam_cc_tfe_3_clk_src[] = {
	F(350000000, P_CAM_CC_PLL7_OUT_EVEN, 1, 0, 0),
	F(570000000, P_CAM_CC_PLL7_OUT_EVEN, 1, 0, 0),
	F(600000000, P_CAM_CC_PLL7_OUT_EVEN, 1, 0, 0),
	F(725000000, P_CAM_CC_PLL7_OUT_EVEN, 1, 0, 0),
	{ }
};

static struct clk_rcg2 cam_cc_tfe_3_clk_src = {
	.cmd_rcgr = 0x1f004,
	.mnd_width = 0,
	.hid_width = 5,
	.parent_map = cam_cc_parent_map_10,
	.freq_tbl = ftbl_cam_cc_tfe_3_clk_src,
	.enable_safe_config = true,
	.flags = HW_CLK_CTRL_MODE,
	.clkr.hw.init = &(const struct clk_init_data){
		.name = "cam_cc_tfe_3_clk_src",
...
static struct clk_rcg2 cam_cc_tfe_3_csid_clk_src = {
	.cmd_rcgr = 0x1f030,
	.mnd_width = 0,
	.hid_width = 5,
	.parent_map = cam_cc_parent_map_0,
	...
	.flags = HW_CLK_CTRL_MODE,
	.clkr.hw.init = &(const struct clk_init_data){
		.name = "cam_cc_tfe_3_csid_clk_src",
		.parent_data = cam_cc_parent_data_0,
		.num_parents = ARRAY_SIZE(cam_cc_parent_data_0),
		.ops = &clk_rcg2_ops,
	},
...
static struct clk_branch cam_cc_tfe_3_ahb_clk = {
	.halt_reg = 0x1f058,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x1f058,
...
static struct clk_branch cam_cc_tfe_3_clk = {
	.halt_reg = 0x1f01c,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x1f01c,
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data){
			.name = "cam_cc_tfe_3_clk",
			.parent_hws = (const struct clk_hw*[]){
				&cam_cc_tfe_3_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch cam_cc_tfe_3_cphy_rx_clk = {
	.halt_reg = 0x1f054,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x1f054,
...
static struct clk_branch cam_cc_tfe_3_csid_clk = {
	.halt_reg = 0x1f048,
	.halt_check = BRANCH_HALT,
	.clkr = {
		.enable_reg = 0x1f048,
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data){
			.name = "cam_cc_tfe_3_csid_clk",
			.parent_hws = (const struct clk_hw*[]){
				&cam_cc_tfe_3_csid_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_regmap *cam_cc_crow_clocks[] = {
	...
	[CAM_CC_TFE_3_AHB_CLK] = &cam_cc_tfe_3_ahb_clk.clkr,
	[CAM_CC_TFE_3_CLK] = &cam_cc_tfe_3_clk.clkr,
	[CAM_CC_TFE_3_CLK_SRC] = &cam_cc_tfe_3_clk_src.clkr,
	[CAM_CC_TFE_3_CPHY_RX_CLK] = &cam_cc_tfe_3_cphy_rx_clk.clkr,
	[CAM_CC_TFE_3_CSID_CLK] = &cam_cc_tfe_3_csid_clk.clkr,
	[CAM_CC_TFE_3_CSID_CLK_SRC] = &cam_cc_tfe_3_csid_clk_src.clkr,
	[CAM_CC_TOP_SHIFT_CLK] = &cam_cc_top_shift_clk.clkr,
	[CAM_CC_XO_CLK_SRC] = &cam_cc_xo_clk_src.clkr,
};

static const struct qcom_reset_map cam_cc_crow_resets[] = {
	...
	[CAM_CC_TFE_3_BCR] = { 0x1f000 },
};

static const struct regmap_config cam_cc_crow_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static struct qcom_cc_desc cam_cc_crow_desc = {
	.config = &cam_cc_crow_regmap_config,
	.clks = cam_cc_crow_clocks,
	.num_clks = ARRAY_SIZE(cam_cc_crow_clocks),
	.resets = cam_cc_crow_resets,
	.num_resets = ARRAY_SIZE(cam_cc_crow_resets),
	.clk_regulators = cam_cc_crow_regulators,
	.num_clk_regulators = ARRAY_SIZE(cam_cc_crow_regulators),
};

static const struct of_device_id cam_cc_crow_match_table[] = {
	{ .compatible = "qcom,crow-camcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, cam_cc_crow_match_table);

static int cam_cc_crow_probe(struct platform_device *pdev)
{
	struct regmap *regmap;
	int ret;

	regmap = qcom_cc_map(pdev, &cam_cc_crow_desc);
	if (IS_ERR(regmap))
		return PTR_ERR(regmap);

	ret = qcom_cc_runtime_init(pdev, &cam_cc_crow_desc);
	if (ret)
		return ret;
	 ...
	 *	cam_cc_gdsc_clk
	 */
	regmap_update_bits(regmap, 0x25038, BIT(0), BIT(0));

	ret = qcom_cc_really_probe(pdev, &cam_cc_crow_desc, regmap);
	if (ret) {
...
static void cam_cc_crow_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &cam_cc_crow_desc);
}

static const struct dev_pm_ops cam_cc_crow_pm_ops = {
	SET_RUNTIME_PM_OPS(qcom_cc_runtime_suspend, qcom_cc_runtime_resume, NULL)
	SET_SYSTEM_SLEEP_PM_OPS(pm_runtime_force_suspend,
				pm_runtime_force_resume)
};

static struct platform_driver cam_cc_crow_driver = {
	.probe = cam_cc_crow_probe,
	.driver = {
		.name = "cam_cc-crow",
		.of_match_table = cam_cc_crow_match_table,
		.sync_state = cam_cc_crow_sync_state,
		.pm = &cam_cc_crow_pm_ops,
	},
};

static int __init cam_cc_crow_init(void)
{
	return platform_driver_register(&cam_cc_crow_driver);
}
subsys_initcall(cam_cc_crow_init);

static void __exit cam_cc_crow_exit(void)
{
	platform_driver_unregister(&cam_cc_crow_driver);
}
module_exit(cam_cc_crow_exit);

MODULE_DESCRIPTION("QTI CAM_CC CROW Driver");
