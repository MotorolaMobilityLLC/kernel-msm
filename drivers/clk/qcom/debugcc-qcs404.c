...
static const char *const gcc_debug_mux_parent_names[] = {
	...
	"measure_only_gcc_bimc_clk",
	"measure_only_gcc_crypto_clk",
	"measure_only_gcc_dcc_clk",
	"measure_only_gcc_dcc_xo_clk",
	"measure_only_gcc_pcnoc_ahb_clk",
	"measure_only_gcc_qpic_clk",
	"measure_only_gcc_sys_noc_axi_clk",
};
...
static int gcc_debug_mux_sels[] = {
	...
	0x15A,		/* measure_only_gcc_bimc_clk */
	0x138,		/* measure_only_gcc_crypto_clk */
	0x1B9,		/* measure_only_gcc_dcc_clk */
	0x1B8,		/* measure_only_gcc_dcc_xo_clk */
	0x008,		/* measure_only_gcc_pcnoc_ahb_clk */
	0xC0,		/* measure_only_gcc_qpic_clk */
	0x0,		/* measure_only_gcc_sys_noc_axi_clk */
};
...
static struct clk_dummy measure_only_gcc_bimc_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
		.name = "measure_only_gcc_bimc_clk",
		.ops = &clk_dummy_ops,
	},
};

static struct clk_dummy measure_only_gcc_crypto_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
		.name = "measure_only_gcc_crypto_clk",
		.ops = &clk_dummy_ops,
	},
};

static struct clk_dummy measure_only_gcc_dcc_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
		.name = "measure_only_gcc_dcc_clk",
		.ops = &clk_dummy_ops,
	},
};

static struct clk_dummy measure_only_gcc_dcc_xo_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
		.name = "measure_only_gcc_dcc_xo_clk",
		.ops = &clk_dummy_ops,
	},
};

static struct clk_dummy measure_only_gcc_pcnoc_ahb_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
		.name = "measure_only_gcc_pcnoc_ahb_clk",
		.ops = &clk_dummy_ops,
	},
};

static struct clk_dummy measure_only_gcc_qpic_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
		.name = "measure_only_gcc_qpic_clk",
		.ops = &clk_dummy_ops,
	},
};

static struct clk_dummy measure_only_gcc_sys_noc_axi_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
		.name = "measure_only_gcc_sys_noc_axi_clk",
		.ops = &clk_dummy_ops,
	},
};
...
static struct clk_hw *debugcc_qcs404_hws[] = {
	...
	&measure_only_gcc_bimc_clk.hw,
	&measure_only_gcc_crypto_clk.hw,
	&measure_only_gcc_dcc_clk.hw,
	&measure_only_gcc_dcc_xo_clk.hw,
	&measure_only_gcc_pcnoc_ahb_clk.hw,
	&measure_only_gcc_qpic_clk.hw,
	&measure_only_gcc_sys_noc_axi_clk.hw,
};
	...
	for (i = 0; i < ARRAY_SIZE(mux_list); i++) {
		...
		if (ret) {
			dev_err(&pdev->dev, "Unable to register mux clk %s, err:(%d)\n",
				qcom_clk_hw_get_name(&mux_list[i].mux->hw), ret);
			return ret;
		}
	}
	...
	for (i = 0; i < ARRAY_SIZE(debugcc_qcs404_hws); i++) {
		...
		if (IS_ERR(clk)) {
			dev_err(&pdev->dev, "Unable to register %s, err:(%d)\n",
				clk_hw_get_name(debugcc_qcs404_hws[i]), PTR_ERR(clk));
			return PTR_ERR(clk);
		}
	}
