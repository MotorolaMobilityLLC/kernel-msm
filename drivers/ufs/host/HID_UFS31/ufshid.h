...
enum ufshid_idn_idx {
	/* UFS 4.0 / 3.1 Use Separate HID IDN idx */
	/* Attribute */
	QUERY_ATTR_IDN_HID_OP_IDX,
	QUERY_ATTR_IDN_HID_OP_3_1_IDX,
	QUERY_ATTR_IDN_HID_FRAG_LV_IDX,
	QUERY_ATTR_IDN_HID_FRAG_LV_3_1_IDX,
	HID_SEPARATION_BOUNDARY,
	/* UFS 4.0 / 3.1 Use Common HID IDN idx */
	/* Attribute */
	...
	QUERY_ATTR_IDN_HID_L2P_DEFRAG_TH_IDX,
	QUERY_ATTR_IDN_HID_FEAT_SUP_IDX,
	HID_IDN_IDX_END,
};

enum ufshid_desc_idx {
	/* UFS 4.0 / 3.1 Use Separate HID Dev/Geometry desc idx */
	/* Device */
	DEV_DESC_PARAM_HID_VER_IDX,
	DEV_DESC_PARAM_HID_VER_3_1_IDX,
	/* Geometry */
	GEO_DESC_HID_MAX_LBA_RANGE_SZ_IDX,
	GEO_DESC_HID_MAX_LBA_RANGE_SZ_3_1_IDX,
	GEO_DESC_HID_MAX_LBA_RANGE_CNT_IDX,
	GEO_DESC_HID_MAX_LBA_RANGE_CNT_3_1_IDX,
	HID_DESC_IDX_END,
};
