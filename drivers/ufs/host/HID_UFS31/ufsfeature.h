...
/* Version info */
#define UFSFEATURE_DD_VER			0x010401
...
enum ufsf_idn_idx {
	DESC_IDN_DEV_IDX = 0,
	DESC_IDN_DEV_3_1_IDX,
	DESC_IDN_GEO_IDX,
	DESC_IDN_GEO_3_1_IDX,
	IDN_IDX_END,
};

enum ufsf_desc_idx {
	DESC_DEV_MAX_SZ_IDX = 0,
	DESC_DEV_MAX_SZ_3_1_IDX,
	DESC_CONF_MAX_SZ_IDX,
	DESC_CONF_MAX_SZ_3_1_IDX,
	DESC_UNIT_MAX_SZ_IDX,
	DESC_UNIT_MAX_SZ_3_1_IDX,
	GEO_MAX_SZ_IDX,
	GEO_MAX_SZ_3_1_IDX,
	DESC_IDX_END,
};
...
void ufsf_event_notify(struct ufs_hba *hba, enum ufs_event_type evt, u32 data);
