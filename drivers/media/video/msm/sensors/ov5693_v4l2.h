...
#ifndef CAMSENSOR_OV5693
#define CAMSENSOR_OV5693

/* OV SENSOR SCCB */
struct ov5693_sensor {
	uint16_t addr;
	uint8_t data;
	uint8_t mask;
};
...
/* Sensor ID */
#define OV5693_SENSOR_ID 0x5693
...
static struct msm_camera_i2c_reg_conf ov5693_snap_settings[] = {
	/*2592*1944 Reference Setting 24M MCLK 2lane 280Mbps/lane 30fps*/
#if 0
	{0x0103, 0x01},
	{0x3001, 0x0a},
	{0x3002, 0x80},
...
#if 1
static struct msm_camera_i2c_reg_conf ov5693_video_60fps_settings[] = {
	/*640*480 Reference Setting 24M MCLK 60fps*/
	{0x0103, 0x01},
	{0x3001, 0x0a},
	{0x3002, 0x80},
	{0x3006, 0x00},
