...
static const char *callback_name[PANICHDL_MAX] = {
	...
	[PANICHDL_ACCEL_RESTORE] = "accel_restore",
	[PANICHDL_COMPASS_RESTORE] = "compass_restore",
	[PANICHDL_GYRO_RESTORE] = "gyro_restore",
	...
	[PANICHDL_BATCH_RESTORE] = "batch_restore",
	[PANICHDL_PPG_RESTORE] = "ppg_restore",
};
