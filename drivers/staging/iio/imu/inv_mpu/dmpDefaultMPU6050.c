...
#define CFG_OUT_3QUAT           (2357)
#define CFG_OUT_6QUAT           (2371)
#define CFG_OUT_PQUAT           (2385)
#define CFG_OUT_ACCL            (2399)
#define CFG_ACCL_PEDSTEP        (2403)
#define CFG_OUT_GYRO            (2419)
#define CFG_PED_ENABLE          (2510)
#define CFG_PEDSTEP_DET         (2760)
#define CFG_DISPLAY_ORIENT_INT  (2084)
#define CFG_PED_INT             (2748)
#define CFG_DR_INT              (1042)
#define CFG_FIFO_INT            (2508)
#define CFG_AUTH                (1048)
#define FCFG_1                  (1075)
#define FCFG_3                  (1100)
#define FCFG_2                  (1079)
#define FCFG_7                  (1086)
#define FCFG_6                  (1118)
#define CFG_EXT_GYRO_BIAS       (1197)
#define CFG_7                   (1416)
#define SMD_TP2                 (1379)
#define SMD_TP1                 (1356)
#define CFG_MOTION_BIAS         (1418)
#define CFG_GYRO_RAW_DATA       (2426)
