...
typedef void (*HTC_TARGET_FAILURE)(void *Instance, A_STATUS Status);
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  @notes:  Caller must initialize packet using SET_HTC_PACKET_INFO_TX() macro.
           ...
           This interface is fully asynchronous.  On error, HTCSendDataPkt will
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  @function name: HTCSetTargetFailureCallback
  @input:  HTCHandle - HTC handle
  ...
  @see also:
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
void HTCSetTargetFailureCallback(HTC_HANDLE HTCHandle,
...
#else
#define HTCReturnReceivePkt(target,p,osbuf)     HTCAddReceivePkt(target,p)
#endif
