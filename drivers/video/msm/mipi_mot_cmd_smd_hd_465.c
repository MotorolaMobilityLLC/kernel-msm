...
static char C8_offset_1[2] = {0xB0, 0x00,};
static char C8_1[12] = {0xC8, 0x01, 0x4B, 0x01, 0x49, 0x01,
		0x80, 0xD1, 0xD1, 0xD1, 0xCC, 0xCC,};
static char C8_offset_2[2] = {0xB0, 0x0B,};
static char C8_2[12] = {0xC8, 0xCC, 0xB1, 0xB0, 0xB1, 0xB7,
		0xB8, 0xB8, 0xC8, 0xCD, 0xCF, 0xBF,};
static char C8_offset_3[2] = {0xB0, 0x16,};
static char C8_3[12] = {0xC8, 0xC5, 0xC9, 0x8D, 0xA2, 0x9C,
		0xE0, 0xDD, 0xD2, 0x0A, 0x0B, 0x0B,};
static char C8_offset_4[2] = {0xB0, 0x21,};
static char C8_4[12] = {0xC8, 0x01, 0x3C, 0x01, 0x3C, 0x01,
		0x71, 0xD5, 0xD3, 0xD3, 0xCF, 0xCF,};
static char C8_offset_5[2] = {0xB0, 0x2C,};
static char C8_5[12] = {0xC8, 0xCF, 0xB1, 0xB1, 0xB1, 0xB7,
		0xB8, 0xBB, 0xC9, 0xCD, 0xCF, 0xBF,};
static char C8_offset_6[2] = {0xB0, 0x37,};
static char C8_6[12] = {0xC8, 0xC5, 0xC9, 0x8D, 0xA2, 0x9C,
		0xE0, 0xDD, 0xD2, 0x0A, 0x0B, 0x0B,};
static char C8_offset_7[2] = {0xB0, 0x42,};
static char C8_7[12] = {0xC8, 0x01, 0x2C, 0x01, 0x2C, 0x01,
		0x5D, 0xD3, 0xD3, 0xD3, 0xCF, 0xCF,};
static char C8_offset_8[2] = {0xB0, 0x4D,};
static char C8_8[12] = {0xC8, 0xCF, 0xB1, 0xB1, 0xB1, 0xB7,
		0xB8, 0xBB, 0xC9, 0xCD, 0xCF, 0xBF,};
static char C8_offset_9[2] = {0xB0, 0x58,};
static char C8_9[12] = {0xC8, 0xC5, 0xC9, 0x8D, 0xA2, 0x9C,
		0xE0, 0xDD, 0xD2, 0x0A, 0x0B, 0x0B,};

static char C9_offset_1[2] = {0xB0, 0x00,};
static char C9_1[12] = {0xC9, 0x01, 0x1B, 0x01, 0x1B, 0x01,
		0x4B, 0xD3, 0xD3, 0xD3, 0xCF, 0xCF,};
static char C9_offset_2[2] = {0xB0, 0x0B,};
static char C9_2[12] = {0xC9, 0xCF, 0xB1, 0xB1, 0xB1, 0xB7,
		0xB8, 0xBB, 0xC9, 0xCD, 0xCF, 0xBF,};
static char C9_offset_3[2] = {0xB0, 0x16,};
static char C9_3[12] = {0xC9, 0xC5, 0xC9, 0x8D, 0xA2, 0x9C,
		0xE0, 0xDD, 0xD2, 0x0A, 0x0B, 0x0B,};
static char C9_offset_4[2] = {0xB0, 0x21,};
static char C9_4[12] =  {0xC9, 0x01, 0x06, 0x01, 0x07, 0x01,
		0x30, 0xD3, 0xD3, 0xD3, 0xCF, 0xCF,};
static char C9_offset_5[2] = {0xB0, 0x2C,};
static char C9_5[12] = {0xC9, 0xCF, 0xB1, 0xB1, 0xB1, 0xB7,
		0xB8, 0xBB, 0xC9, 0xCD, 0xCF, 0xBF,};
static char C9_offset_6[2] = {0xB0, 0x37,};
static char C9_6[12] = {0xC9, 0xC5, 0xC9, 0x8D, 0xA2, 0x9C,
		0xE0, 0xDD, 0xD2, 0x0A, 0x0B, 0x0B,};
static char C9_offset_7[2] = {0xB0, 0x42,};
static char C9_7[12] = {0xC9, 0x00, 0xFF, 0x00, 0xFF, 0x01,
		0x28, 0xD3, 0xD3, 0xD3, 0xCF, 0xCF,};
static char C9_offset_8[2] = {0xB0, 0x4D,};
static char C9_8[12] = {0xC9, 0xCF, 0xB1, 0xB1, 0xB1, 0xB7,
		0xB8, 0xBB, 0xC9, 0xCD, 0xCF, 0xBF,};
static char C9_offset_9[2] = {0xB0, 0x58,};
static char C9_9[12] = {0xC9, 0xC5, 0xC9, 0x8D, 0xA2, 0x9C,
		0xE0, 0xDD, 0xD2, 0x0A, 0x0B, 0x0B,};
static char C9_offset_10[2] = {0xB0, 0x63,};
static char C9_10[12] = {0xC9, 0x00, 0xD3, 0x00, 0xD7, 0x00,
		0xF7, 0xD3, 0xD3, 0xD3, 0xCF, 0xCF};
static char C9_offset_11[2] = {0xB0, 0x6E,};
static char C9_11[12] = {0xC9, 0xCF, 0xB1, 0xB1, 0xB1, 0xB7,
		0xB8, 0xBB, 0xC9, 0xCD, 0xCF, 0xBF,};
static char C9_offset_12[2] = {0xB0, 0x79,};
static char C9_12[12] = {0xC9, 0xC5, 0xC9, 0x8D, 0xA2, 0x9C,
		0xE0, 0xDD, 0xD2, 0x0A, 0x0B, 0x0B,};

static char wr_ctrl_disp[2] = {0x53, 0x28};
...
static struct dsi_cmd_desc c8_c9_53_c7_reg[] = {
	...
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_offset_1), C8_offset_1},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_1), C8_1},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_offset_2), C8_offset_2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_2), C8_2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_offset_3), C8_offset_3},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_3), C8_3},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_offset_4), C8_offset_4},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_4), C8_4},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_offset_5), C8_offset_5},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_5), C8_5},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_offset_6), C8_offset_6},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_6), C8_6},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_offset_7), C8_offset_7},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_7), C8_7},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_offset_8), C8_offset_8},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_8), C8_8},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_offset_9), C8_offset_9},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C8_9), C8_9},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_offset_1), C9_offset_1},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_1), C9_1},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_offset_2), C9_offset_2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_2), C9_2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_offset_3), C9_offset_3},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_3), C9_3},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_offset_4), C9_offset_4},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_4), C9_4},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_offset_5), C9_offset_5},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_5), C9_5},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_offset_6), C9_offset_6},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_6), C9_6},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_offset_7), C9_offset_7},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_7), C9_7},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_offset_8), C9_offset_8},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_8), C9_8},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_offset_9), C9_offset_9},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_9), C9_9},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_offset_10), C9_offset_10},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_10), C9_10},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_offset_11), C9_offset_11},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_11), C9_11},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_offset_12), C9_offset_12},
	{DTYPE_DCS_LWRITE, 1, 0, 0, DEFAULT_DELAY,
		sizeof(C9_12), C9_12},
	{DTYPE_DCS_WRITE1, 1, 0, 0, DEFAULT_DELAY,
