...
struct MIPI_Video_Format {
	...
	unsigned long MIPI_pixel_frequency;
...
void SP_TX_AUX_POLLING_ENABLE(BYTE benable);
...
_SP_TX_DRV_EX_C_ struct MIPI_Video_Format mipi_video_timing_table[];
_SP_TX_DRV_EX_C_ unsigned int mipi_lane_count;
