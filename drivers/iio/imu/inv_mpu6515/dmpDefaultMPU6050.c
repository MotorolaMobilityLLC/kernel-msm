...
#define CFG_OUT_PRESS       (1883)
#define CFG_PED_ENABLE      (1996)
#define CFG_OUT_GYRO        (1815)
#define CFG_PEDSTEP_DET     (2855)
#define OUT_GYRO_DAT        (1824)
#define CFG_FIFO_INT        (1994)
#define OUT_CPASS_DAT       (1858)
#define CFG_AUTH            (1110)
#define OUT_ACCL_DAT        (1790)
#define FCFG_1              (1138)
#define FCFG_3              (1163)
#define FCFG_2              (1142)
#define CFG_OUT_CPASS       (1849)
#define FCFG_7              (1149)
#define CFG_OUT_3QUAT       (1677)
#define OUT_PRESS_DAT       (1892)
#define OUT_3QUAT_DAT       (1687)
#define CFG_7               (1360)
#define OUT_PQUAT_DAT       (1756)
#define CFG_OUT_6QUAT       (1712)
#define CFG_PED_INT         (2844)
#define SMD_TP2             (1325)
#define SMD_TP1             (1304)
#define CFG_MOTION_BIAS     (1362)
#define CFG_OUT_ACCL        (1781)
#define CFG_OUT_STEPDET     (1647)
#define OUT_6QUAT_DAT       (1722)
#define CFG_OUT_PQUAT       (1747)
