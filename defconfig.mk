...
KERNEL_ENG_DEFCONFIG            := $(LJAPDEFCONFIGSRC)/eng-$(DEFCONFIG_BASENAME).config
...
#Add a eng defconfig if it exists for an eng build variant
ifeq ($(TARGET_BUILD_VARIANT), eng)
ifneq ($(wildcard $(KERNEL_ENG_DEFCONFIG)),)
PRODUCT_SPECIFIC_DEFCONFIGS += $(KERNEL_ENG_DEFCONFIG)
endif
endif
#End - Eng defconfig
