...
PRODUCT_DEBUG_DEFCONFIG         := $(LJAPDEFCONFIGSRC)/$(PRODUCT_DEBUG_DEFCONFIG)
...
ifneq ($(wildcard $(PRODUCT_DEBUG_DEFCONFIG)),)
PRODUCT_SPECIFIC_DEFCONFIGS += $(PRODUCT_DEBUG_DEFCONFIG)
endif
endif
endif
endif
