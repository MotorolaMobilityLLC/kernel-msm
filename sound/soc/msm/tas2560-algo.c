			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ret = afe_tas2560_algo_ctrl(ptr, paramid, moduleid,
			TAS2560_ALGO_GET_PARAM, sizeof(u32));
	ucontrol->value.integer.value[0] = ((int32_t *)buff)[0];
	pr_debug("TAS2560_ALGO:%s status data %d", __func__,
			((int32_t *)buff)[0]);
	return ret;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ret = afe_tas2560_algo_ctrl(ptr, paramid, moduleid,
			TAS2560_ALGO_GET_PARAM, sizeof(u32));
	ucontrol->value.integer.value[0] = ((int32_t *)buff)[0];
	pr_debug("TAS2560_ALGO:%s Recieving Rx-Enable data %d", __func__,
		((int32_t *)buff)[0]);
	return ret;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ret = afe_tas2560_algo_ctrl(ptr, paramid, moduleid,
			TAS2560_ALGO_GET_PARAM, sizeof(u32));
	ucontrol->value.integer.value[0] = ((int32_t *)buff)[0];
	pr_debug("TAS2560_ALGO:%s Recieving Tx-Enable data %d", __func__,
		((int32_t *)buff)[0]);
	return ret;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	pr_debug("TAS2560_ALGO:%s Sending Tx-Enable data %d", __func__,
		((int32_t *)buff)[0]);
