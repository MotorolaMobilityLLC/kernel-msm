...
static int tomtom_volatile(struct snd_soc_codec *ssc, unsigned int reg)
{
	...
	switch (reg) {
	case TOMTOM_A_CDC_SPKR_CLIPDET_VAL0:
	case TOMTOM_A_CDC_SPKR_CLIPDET_VAL1:
	case TOMTOM_A_CDC_SPKR_CLIPDET_VAL2:
	case TOMTOM_A_CDC_SPKR_CLIPDET_VAL3:
	case TOMTOM_A_CDC_SPKR_CLIPDET_VAL4:
	case TOMTOM_A_CDC_SPKR_CLIPDET_VAL5:
	case TOMTOM_A_CDC_SPKR_CLIPDET_VAL6:
	case TOMTOM_A_CDC_SPKR_CLIPDET_VAL7:
	case TOMTOM_A_CDC_SPKR2_CLIPDET_VAL0:
	case TOMTOM_A_CDC_SPKR2_CLIPDET_VAL1:
	case TOMTOM_A_CDC_SPKR2_CLIPDET_VAL2:
	case TOMTOM_A_CDC_SPKR2_CLIPDET_VAL3:
	case TOMTOM_A_CDC_SPKR2_CLIPDET_VAL4:
	case TOMTOM_A_CDC_SPKR2_CLIPDET_VAL5:
	case TOMTOM_A_CDC_SPKR2_CLIPDET_VAL6:
	case TOMTOM_A_CDC_SPKR2_CLIPDET_VAL7:
...
static int tomtom_codec_probe(struct snd_soc_codec *codec)
{
	...
	tomtom = kzalloc(sizeof(struct tomtom_priv), GFP_KERNEL);
	if (!tomtom) {
